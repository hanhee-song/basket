...
*/
var aa=__webpack_require__(6),l=__webpack_require__(11),B=__webpack_require__(1),C=__webpack_require__(0),ba=__webpack_require__(12),da=__webpack_require__(13),ea=__webpack_require__(14),fa=__webpack_require__(15),ia=__webpack_require__(16),D=__webpack_require__(2);
...
var BasketForm = function (_React$Component) {
  _inherits(BasketForm, _React$Component);

  function BasketForm(props) {
    _classCallCheck(this, BasketForm);

    var _this = _possibleConstructorReturn(this, (BasketForm.__proto__ || Object.getPrototypeOf(BasketForm)).call(this, props));
  ...
  _createClass(BasketForm, [{
    ...
    value: function handleQuantityChange(num) {
      ...
      return function (e) {
        if (num) {
          var newVal = _this2.state.quantity + num;
          if (newVal >= 1) {
            _this2.setState({ quantity: newVal });
          }
        } else {
          if (e.target.value >= 1) {
            _this2.setState({ quantity: e.target.value });
          } else {
            _this2.setState({ quantity: 1 });
          }
        }
      };
    }
